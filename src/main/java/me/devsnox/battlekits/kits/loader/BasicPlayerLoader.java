...
public class BasicPlayerLoader implements PlayerLoader {
    ...
    public BasicPlayerLoader(KitManager kitManager, File dataFolder) {
        this.kitManager = kitManager;

        this.table = "battlekits_users";

        this.skyConnection = new SkyConnection(new ConnectionConfig(dataFolder, new File(dataFolder + File.separator + "mysql.yml")));
